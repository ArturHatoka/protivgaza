<?php
define(MySQLprefix, "pgaz");
$m_Link = mysql_connect("p291927.mysql.ihc.ru", "p291927_protii", "gh5dtnbr") or die ("<!-- Ошибка подключения к серверу. -->");
mysql_query("SET NAMES utf8");
mysql_select_db("p291927_protii") or die ("<!-- Ошибка соединения с БД. -->");
